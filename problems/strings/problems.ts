...
export const STRING_PROBLEMS: Problem[] = [
  {
    ...
    inputs: [
      { id: 'names', label: 'Enter names (comma-separated):', type: InputType.Text, placeholder: 'John, Jane, Alexander' },
    ],
  ...
  },
  {
    ...
    inputs: [
      { id: 'str', label: 'Enter a string:', type: InputType.Text, placeholder: 'programming' },
    ],
  ...
  },
  {
    ...
    inputs: [
        { id: 'str', label: 'Enter a string:', type: InputType.Text, placeholder: 'e.g., JavaScript' }
    ],
  ...
  },
  {
    ...
    inputs: [
        { id: 'sentence', label: 'Enter a sentence:', type: InputType.Text, placeholder: 'This is a sample sentence.' }
    ],
  ...
  },
  {
    ...
    inputs: [
        { id: 'sentence', label: 'Enter a sentence:', type: InputType.Text, placeholder: 'the quick brown fox' }
    ],
  ...
  },
  {
    ...
    inputs: [
        { id: 'str', label: 'Enter original string:', type: InputType.Text, placeholder: 'Hello world' },
        { id: 'search', label: 'Word to replace:', type: InputType.Text, placeholder: 'world' },
        { id: 'replace', label: 'Replacement word:', type: InputType.Text, placeholder: 'JavaScript' }
    ],
    buttonText: 'Replace',
  ...
  },
  {
    ...
    inputs: [
        { id: 'str', label: 'Enter a string with spaces:', type: InputType.Text, placeholder: '   Hello World   ' }
    ],
  ...
  },
  {
    ...
    inputs: [
        { id: 'str', label: 'Enter a string:', type: InputType.Text, placeholder: 'JavaScript' },
        { id: 'prefix', label: 'Enter prefix to check:', type: InputType.Text, placeholder: 'Java' }
    ],
  ...
  },
  {
    ...
    inputs: [
        { id: 'str', label: 'Enter a string:', type: InputType.Text, placeholder: 'JavaScript' },
        { id: 'suffix', label: 'Enter suffix to check:', type: InputType.Text, placeholder: 'Script' }
    ],
  ...
  },
  {
    ...
    inputs: [
        { id: 'str', label: 'Enter a string:', type: InputType.Text, placeholder: 'Ha' },
        { id: 'count', label: 'Enter repeat count:', type: InputType.Number, placeholder: '3', min: 0 }
    ],
  ...
  },
  {
    ...
    inputs: [
        { id: 'str', label: 'Enter a string:', type: InputType.Text, placeholder: 'aaabbcccc' }
    ],
    buttonText: 'Compress',
