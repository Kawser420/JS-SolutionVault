...
export const ARRAY_PROBLEMS: Problem[] = [
  {
    ...
    inputs: [
      { id: 'numbers', label: 'Enter numbers (comma-separated):', type: InputType.Text, placeholder: '1, 2, 3, 4' },
    ],
  ...
  },
  {
    ...
    inputs: [
      { id: 'numbers', label: 'Enter numbers (comma-separated):', type: InputType.Text, placeholder: '10, 5, 25, 8' },
    ],
  ...
  },
  {
    ...
    inputs: [
        { id: 'array', label: 'Enter elements (comma-separated):', type: InputType.Text, placeholder: '1, 2, 3, 4' }
    ],
  ...
  },
  {
    ...
    inputs: [
        { id: 'array', label: 'Enter numbers (comma-separated):', type: InputType.Text, placeholder: '5, 2, 8, 1' }
    ],
  ...
  },
  {
    ...
    inputs: [
        { id: 'array', label: 'Enter elements (comma-separated):', type: InputType.Text, placeholder: '1, 2, 2, 3, 4, 4' }
    ],
  ...
  },
  {
    ...
    inputs: [
        { id: 'array1', label: 'Enter first array:', type: InputType.Text, placeholder: '1, 2, 3' },
        { id: 'array2', label: 'Enter second array:', type: InputType.Text, placeholder: '2, 3, 4' }
    ],
  ...
  },
  {
    ...
    inputs: [
        { id: 'array1', label: 'Enter first array:', type: InputType.Text, placeholder: '1, 2, 3' },
        { id: 'array2', label: 'Enter second array:', type: InputType.Text, placeholder: '3, 4, 5' }
    ],
  ...
  },
  {
    ...
    inputs: [
        { id: 'array', label: 'Enter numbers (comma-separated):', type: InputType.Text, placeholder: '1, 2, 3, 4, 5, 6' }
    ],
  ...
  },
  {
    ...
    inputs: [
        { id: 'array', label: 'Enter numbers (comma-separated):', type: InputType.Text, placeholder: '1, 2, 3, 4, 5' },
        { id: 'value', label: 'Enter number to find:', type: InputType.Number, placeholder: '3' }
    ],
  ...
  },
  {
    ...
    inputs: [
        { id: 'array', label: 'Enter elements (comma-separated):', type: InputType.Text, placeholder: 'apple, banana, orange' },
        { id: 'separator', label: 'Enter separator:', type: InputType.Text, placeholder: ' - ' }
    ],
  ...
  },
  {
    ...
    inputs: [
        { id: 'array', label: 'Enter elements (comma-separated):', type: InputType.Text, placeholder: '1, 2, 3, 4, 5' },
        { id: 'start', label: 'Start index:', type: InputType.Number, placeholder: '1' },
        { id: 'end', label: 'End index (optional):', type: InputType.Number, placeholder: '4' }
    ],
  ...
  },
  {
    ...
    inputs: [
        { id: 'array', label: 'Enter elements (comma-separated):', type: InputType.Text, placeholder: '1, 2, 3, 4, 5' },
        { id: 'start', label: 'Start index:', type: InputType.Number, placeholder: '1' },
        { id: 'deleteCount', label: 'Delete count:', type: InputType.Number, placeholder: '2' }
    ],
  ...
  },
  {
    ...
    inputs: [
        { id: 'array1', label: 'Enter first array:', type: InputType.Text, placeholder: '1, 2' },
        { id: 'array2', label: 'Enter second array:', type: InputType.Text, placeholder: '3, 4' }
    ],
  ...
  },
  {
    ...
    inputs: [
        { id: 'array', label: 'Enter numbers (comma-separated):', type: InputType.Text, placeholder: '1, 5, 9' }
    ],
  ...
  },
  {
    ...
    inputs: [
        { id: 'array', label: 'Enter nested array (JSON format):', type: InputType.Text, placeholder: '[1, [2, [3, 4], 5]]' }
    ],
  ...
  },
  {
    ...
    inputs: [
        { id: 'array', label: 'Enter elements (comma-separated):', type: InputType.Text, placeholder: '1, 2, 3, 4, 5, 6, 7' },
        { id: 'size', label: 'Chunk size:', type: InputType.Number, placeholder: '3', min: 1 }
    ],
  ...
  },
  {
    ...
    inputs: [
        { id: 'array', label: 'Enter elements (comma-separated):', type: InputType.Text, placeholder: '1, 2, 3, 4, 5' },
        { id: 'steps', label: 'Rotation steps (positive for right, negative for left):', type: InputType.Number, placeholder: '2' }
    ],
  ...
  },
  {
    ...
    inputs: [
        { id: 'array', label: 'Enter sorted array (comma-separated):', type: InputType.Text, placeholder: '2, 5, 8, 12, 16, 23, 38' },
        { id: 'target', label: 'Enter value to find:', type: InputType.Number, placeholder: '16' }
    ],
    buttonText: 'Search',
  ...
  },
  {
    ...
    inputs: [
        { id: 'array', label: 'Enter array (comma-separated):', type: InputType.Text, placeholder: '10, 20, 80, 30, 60' },
        { id: 'target', label: 'Enter value to find:', type: InputType.Number, placeholder: '80' }
    ],
    buttonText: 'Search',
  ...
  },
  {
    ...
    inputs: [
        { id: 'array', label: 'Enter numbers (comma-separated):', type: InputType.Text, placeholder: '2, 7, 11, 15' },
        { id: 'target', label: 'Enter target sum:', type: InputType.Number, placeholder: '9' }
    ],
  ...
  },
  {
    ...
    inputs: [
        { id: 'array', label: 'Enter numbers (comma-separated):', type: InputType.Text, placeholder: '-2, 1, -3, 4, -1, 2, 1, -5, 4' }
    ],
  ...
  },
  {
    ...
    inputs: [
        { id: 'array', label: 'Enter list elements (comma-separated):', type: InputType.Text, placeholder: '1, 2, 3, 4, 5' }
    ],
  ...
  },
  {
    ...
    inputs: [
        { id: 'list1', label: 'Enter first sorted list:', type: InputType.Text, placeholder: '1, 3, 5' },
        { id: 'list2', label: 'Enter second sorted list:', type: InputType.Text, placeholder: '2, 4, 6' }
    ],
  ...
  },
  {
    ...
    inputs: [
        { id: 'array', label: 'Enter numbers (comma separated):', type: InputType.Text, placeholder: '1, 5, 2' }
    ],
  ...
  },
  {
    ...
    inputs: [
        { id: 'array', label: 'Enter numbers (comma separated):', type: InputType.Text, placeholder: '5, 1, 2' }
    ],
  ...
  },
  {
    ...
    inputs: [
        { id: 'array', label: 'Enter numbers (comma separated):', type: InputType.Text, placeholder: '1, 2, 3' }
    ],
  ...
  },
  {
    ...
    inputs: [
        { id: 'array', label: 'Enter array (comma separated):', type: InputType.Text, placeholder: '1, 2, 3, 4, 5' },
        { id: 'steps', label: 'Enter steps:', type: InputType.Number, placeholder: '2', min: 0 }
    ],
  ...
  },
  {
    ...
    inputs: [
        { id: 'array', label: 'Enter elements (comma separated):', type: InputType.Text, placeholder: 'apple, banana, apple, orange' }
    ],
