...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const navClasses =
    "fixed top-0 left-0 h-full w-64 bg-[--card-bg] border-r border-[--border-color] z-40 transform transition-transform duration-300 ease-in-out lg:translate-x-0";
    ...
    <>
      ...
      >
        <div className="flex items-center justify-between p-4 border-b border-[--border-color]">
          ...
          <button
            onClick={() => setIsOpen(false)}
            className="lg:hidden text-[--text-color]"
          >
